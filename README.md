...
.col4 > nav.s-menu > a.m-itm:not(:nth-child(1)):not(:nth-child(6)) > svg
div.-fw-w:nth-child(1) > a.-fs0 > img
article.-df > svg > use
svg.ic.xprss
svg.ic[alt*="Express"]
svg.ic[aria-label*="Express"]
svg.ic[aria-label*="Global"]
...
CSS
.cover img, .logowrapper, div[data-qa="restaurant-logo"],
...
[data-stat-action*="facebook"] svg
[data-stat-action*="instagram"] svg
[data-stat-action*="twitter"] svg
button.reset
...
#sprite-news path, #sprite-podcast path, #sprite-direct path, #sprite-profile path {
...
CSS
article.single .sticky-header button.button-share,
...
CSS
.class_title,.content-sec,.f-d-w,.left-sec,.sub_nav_wrap,.tb_footer,.u-f-item {
    background: ${white} !important;
}
...
CSS
.treccani_portal .wrapper, .treccani_portal body {
    background-color: ${white} !important;
}
...
CSS
#logo a {
    background: url("https://tweakers.net/g/if/v3/framework/tweakers_logo_v2_x1.png") no-repeat center !important;;
}
...
img[src*="1D_normal_modes_%28280_kB%29.gif"]
img[src*="Woven_bone_matrix.jpg"]
img[src*="Nano_Si_640x480.jpg"]
img[src*="Plastic_household_items.jpg"]
img[src*="QuantumPhaseTransition.svg.png"]
img[src*="SiO%C2%B2_Quartz.svg.png"]
img[src*="Silica.svg.png"]
img[src*="Different_minerals.jpg"]
img[src*="2006-01-14_Surface_waves.jpg"]
img[src*="Phase-diag2.svg.png"]
img[src*="Lennard-Jones_Radial_Distribution_Function.svg.png"]
img[src*="Teilchenmodell_Fl%C3%BCssigkeit.svg.png"]
img[src*="Diffusion_animation.gif"]
img[src*="Gas_particle_movement.svg.png"]
img[src*="3D_model_hydrogen_bonds_in_water.svg.png"]
img[src*="170px-Boyle_air_pump.jpg"]
img[src*="Daltons_symbols.gif"]
img[src*="Compressibility_Factor_of_Air_75-200_K.png"]
img[src*="170px-Vortex-street-1.jpg"]
img[src*="Magnetic_rope.svg.png"]
img[src*="Simple_representation_of_a_discharge_tube_-_plasma.png"]
img[src*="Cascade-process-of-ionization.svg.png"]
img[src*="Townsend_Discharge.svg.png"]
img[src*="Melting_icecubes.gif"]
img[src*="440px-Comparison_carbon_dioxide_water_phase_diagrams.svg.png"]
img[src*="Nickelocen_an_einem_K%C3%BChlfinger.jpg"]
img[src*="Dry_Ice_Vapor_%2817490553041%29.jpg"]
img[src*="Sublimation_reaction_of_naphthalene.jpg"]
img[src*="Camphor_sublimation_1.jpg"]
img[src*="Ferrocen.jpg"]
img[src*="Light_glinting_off_icicles.jpg"]
img[src*="77855181_bromine624.jpg"]
img[src*="Phase_change_-_en.svg.png"]
img[src*="Electron_avalanche.gif"]
img[src*="First_Ionization_Energy.svg.png"]
img[src*="Tunnel_ionization_3.png"]
img[src*="Lambda_type_population_trapping.png"]
img[src*="Kuchiev%27s_model.png"]
img[src*="Mixtures_and_Pure_Substances_2x2.svg.png"]
img[src*="Liquidnitrogen.jpg"]
img[src*="N2MolecularDiagramCR.jpg"]
img[src*="RuA5N2.png"]
img[src*="Mountainous_Shoreline_of_Sputnik_Planum_%28PIA20198%29.png"]
img[src*="Borazin_Mesomers.png"]
img[src*="Nitrogen_electrode_potentials.svg.png"]
img[src*="Nitrogen_trichloride.JPG"]
img[src*="Fuming_nitric_acid_40ml.jpg"]
img[src*="Nitrogen_Cycle.svg.png"]
img[src*="A_cylinder_container%2C_containing_liquid_nitrogen.jpg"]
img[src*="Gas_Detector_.jpg"]
img[src*="Hydrogen_atom.svg.png"]
img[src*="Protium.svg.png"]
img[src*="Hydrogen_production_via_Electrolysis.png"]
img[src*="Methane_Pyrolysis-1.png"]
img[src*="SMR%2BWGS-1.png"]
img[src*="Trionfi_di_Cibele_e_Juno.jpg"]
img[src*="Saccharose.svg.png"]
img[src*="Rock-Candy-Closeup.jpg"]
img[src*="SaltInWaterSolutionLiquid.jpg"]
img[src*="States_of_Matter.JPG"]
img[src*="Phase_diagram_of_water_simplified.svg.png"]
img[src*="Tetrahedral_Structure_of_Water.png"]
img[src*="Auto-and_heterotrophs.svg.png"]
img[src*="Water_withdrawals_per_capita%2C_OWID.svg.png"]
img[src*="2006_Global_Water_Availability.svg.png"]
img[src*="DIN_4844-2_D-P005.svg.png"]
img[src*="Sterilewater.jpg"]
img[src*="Band_5_ALMA_receiver.jpg"]
img[src*="Access_to_drinking_water_in_third_world.svg.png"]
img[src*="Cubic.svg.png"]
img[src*="Cubic-body-centered.svg.png"]
img[src*="Cubic-face-centered.svg.png"]
img[src*="FCC_primative-cubic_cells.svg.png"]
img[src*="NaCl_polyhedra.png"]
img[src*="Visualisation_diamond_cubic.svg.png"]
img[src*="CsCl_crystal.png"]
img[src*="12-14-hedral_honeycomb.png"]
img[src*="Sphalerite-unit-cell-depth-fade-3D-balls.png"]
img[src*="Carbon-dioxide-2D-dimensions.svg.png"]
img[src*="Co2_vibrations.svg.png"]
img[src*="Carbon_dioxide_pressure-temperature_phase_diagram.svg.png"]
img[src*="Global_carbon_budget_components.png"]
img[src*="CO2_increase_rate.png"]
img[src*="Mauna_Loa_CO2_monthly_mean_concentration.svg.png"]
img[src*="Calvin-cycle4.svg.png"]
img[src*="Auto-and_heterotrophs.png"]
img[src*="Main_symptoms_of_carbon_dioxide_toxicity.svg.png"]
img[src*="CO2Mini_monitor.jpg"]
img[src*="Friedrich_Witte_Fabrik.jpg"]
img[src*="Brillanten.jpg"]
img[src*="Copper_sulfate.jpg"]
img[src*="Carbon_basic_phase_diagram.png"]
img[src*="Diamond_face_trigons_scale.jpg"]
img[src*="Eclogite%2C_d%C3%A9tail_de_la_roche.jpg"]
img[src*="Garnet_inclusion_in_diamond.jpg"]
img[src*="VolcanicPipe.jpg"]
img[src*="Diamond_Balance_Scale_0.01_-_25_Carats_Jewelers_Measuring_Tool.jpg"]
img[src*="2014_Diamonds_Countries_Export_Treemap.png"]
img[src*="The_Daria-e_Noor_%28Sea_of_Light%29_Diamond_from_the_collection_of_the_national_jewels_of_Iran_at_Central_Bank_of_Islamic_Republic_of_Iran.jpg"]
img[src*="Apollo_synthetic_diamond.jpg"]
img[src*="CuSO4_%285aq%29.jpg"]
img[src*="Arseniosiderite-Boothite-sea69a.jpg"]
img[src*="Copper_sulfate_anhydrous.jpg"]
img[src*="Carbonado_diamondites_Bangui_region%2C_Central_African_Republic.jpg"]
img[src*="Methane-2D-dimensions.svg.png"]
img[src*="The_Creation_of_Methane_Within_a_Ruminant.svg.png"]
img[src*="Diagram_of_sustainable_methane_fuel_production.PNG"]
img[src*="Mlo_ch4_ts_obs_03437.png"]
img[src*="Air_density_vs_temperature.svg.png"]
img[src*="Molar_volumes_of_liquid_and_solid_phase_of_elements.jpg"]
img[src*="Cast_iron_tensile_test.JPG"]
img[src*="Ductility.svg.png"]
img[src*="Graphite-and-diamond-with-scale.jpg"]
img[src*="Carbon-phase-diagramp.svg.png"]
img[src*="Glassy_carbon_and_a_1cm3_graphite_cube_HP68-79.jpg"]
img[src*="Eight_Allotropes_of_Carbon.svg.png"]
img[src*="Methane-2D-stereo.svg.png"]
img[src*="Akiba%27s_%22hypervalent_carbon%22_compound.png"]
img[src*="Charcoal_sticks_051907.jpg"]
img[src*="Tungsten_carbide.jpg"]
img[src*="Mechanical_pencil_lead_spilling_out_051907.jpg"]
img[src*="WOA05_GLODAP_pd_DIC_AYool.png"]
img[src*="Global_Diamond_Output_in_2005.png"]
img[src*="Petroleum_sample.jpg"]
img[src*="Oil_Reserves.png"]
img[src*="Total_World_Oil_Reserves_Conventional_Unconventional.png"]
img[src*="Octane_molecule_3D_model.png"]
img[src*="Treibs%26Chlorophyll.png"]
img[src*="Structural_Trap_%28Anticlinal%29.svg.png"]
img[src*="Crudes.PNG"]
img[src*="Reservespie.png"]
img[src*="Crude_oil_prices_since_1861.png"]
img[src*="Graph_price_of_oil_1861_to_2020_WID_data.png"]
img[src*="World_energy_consumption.svg.png"]
img[src*="Oil_consumption_per_day_by_region_from_1980_to_2006.svg.png"]
img[src*="Oil_consumption_per_day_by_region_from_1980_to_2006_solid3.svg.png"]
img[src*="World_oil_consumption_1980_to_2007_by_region.svg.png"]
img[src*="OilConsumptionpercapita.png"]
img[src*="2014_Petroleum_Countries_Export_Treemap.png"]
img[src*="Oil_exports.PNG"]
img[src*="Oil_imports.PNG"]
img[src*="Carbonate_system_of_seawater.svg.png"]
img[src*="GlobalPeakOilForecast.jpg"]
img[src*="US_Crude_Oil_Production_and_Imports.svg.png"]
img[src*="PIA10008_Seas_and_Lakes_on_Titan.jpg"]
img[src*="Silane.png"]
img[src*="PDMS.svg.png"]
img[src*="Sulfuric-acid-Givan-et-al-1999-3D-balls.png"]
img[src*="Early_genetic_code.svg.png"]
img[src*="Mikmaq_State_Flag.svg.png"]
img[src*="Bandera_Sechelt.png"]
img[src*="Bandera_Red_Earth_Cree.PNG"]
img[src*="Ouje_Bougounou_Cree.jpg"]
img[src*="Theiroquoislonghouse.png"]
img[src*="Non-Native-American-Nations-Territorial-Claims-over-NAFTA-countries-1750-2008.gif"]
img[src*="Censusdivisions-ethnic.png"]
img[src*="GitHub_logo_2013.svg.png"]
img[src*="Font_Awesome_5_brands_github.svg.png"]
img[src*="Mapping_collaborative_software_on_GitHub.png"]
img[src*="Octicons-terminal.svg.png"]
img[src*="Homepage_of_Wikipedia.png"]
img[src*="Open-Xchange_day_view.png"]
img[src*="Windows_10_Calculator.png"]
img[src*="Windows_7_Calculator.png"]
img[src*="Microsoft_Windows_NT_Calculator_Version_3.1_261x269.png"]
img[src*="Markovkate_01.svg.png"]
img[src*="Markov-cheese-lettuce-grapes.svg.png"]
img[src*="Intensities_vs_transition_probabilities.svg.png"]
img[src*="PageRank_with_Markov_Chain"]
img[src*="SourceForge.net_-_Download_Forbidden.png"]
img[src*="SF.net_Diagramm.png"]
img[src*="Stachledraht_DDos_Attack.svg.png"]
img[src*="GitLab_running_11.0_%282018-07%29.png"]
img[src*="Australian_Toilet.JPG"]
img[src*="Old_toilet_with_elevated_cistern_and_chain.jpg"]
img[src*="Japan_toilet.jpg"]
img[src*="Notariskantoor_Valkenswaard_10.JPG"]
img[src*="CAN_orthographic.svg.png"]
img[src*="Langs_N.Amer.svg.png"]
img[src*="Nouvelle-France_map-en.svg.png"]
img[src*="Canada_provinces_evolution_2.gif"]
img[src*="Canadiancharterofrightsandfreedoms.jpg"]
img[src*="Terrestrial_ecozones_and_ecoprovinces_of_Canada%2C_2017.gif"]
img[src*="Canada_K%C3%B6ppen.svg.png"]
img[src*="Political_map_of_Canada.svg.png"]
img[src*="Quebec-Windsor_Corridor.svg.png"]
img[src*="Supreme_court_of_Canada_in_summer.jpg"]
img[src*="Git_operations.svg.png"]
img[src*="GNOME_gitg.png"]
img[src*="Gitweb.png"]
img[src*="Wasserhahn.jpg"]
img[src*="LatrinaRoma.jpg"]
img[src*="Double-trap_siphonic_WC.svg.png"]
img[src*="Diagram_of_a_jet-siphonic_WC_bowl.svg.png"]
img[src*="Four_types_of_pedestal_WC.svg.png"]
img[src*="Siphonic_WC_cistern.svg.png"]
img[src*="Concentric_Float_Valve.svg.png"]
img[src*="Ballcock.svg.png"]
img[src*="Flushing_toilet.jpg"]
img[src*="Squattoilet.jpg"]
img[src*="DE_Toilette.JPG"]
img[src*="Toilet_photo.jpg"]
img[src*="Cummings_S-bend.jpg"]
img[src*="Old_toilet_with_elevated_cistern_and_chain.jpg"]
img[src*="Bramah_water_closet.jpg"]
img[src*="Ad_1884_twyford.jpg"]
img[src*="Thomas_Crapper_toilet_ad.gif"]
...
CSS
.pfmContent, .categoryInputElement, div.yui-overlay, .yui-dt-data td, body {
    background-color: black !important;
    background-image: none !important;
}
...
CSS
.hb-trigger-inner,
.hb-trigger-inner::before, 
.hb-trigger-inner::after {
    background-color: ${rgb(48, 51, 53)} !important;
}
.hb-trigger:hover .hb-trigger-inner,
.hb-trigger:hover .hb-trigger-inner::before,
.hb-trigger:hover .hb-trigger-inner::after,
.hb-trigger:active .hb-trigger-inner,
.hb-trigger:active .hb-trigger-inner::before,
.hb-trigger:active .hb-trigger-inner::after,
.hb-trigger:focus .hb-trigger-inner,
.hb-trigger:focus .hb-trigger-inner::before,
.hb-trigger:focus .hb-trigger-inner::after {
    background-color: ${black} !important;
}
body.tag {
    color: ${#333} !important;
...
button.ytp-cards-button .ytp-cards-button-icon .ytp-svg-shadow {
    fill: ${white} !important;
}
...
CSS
.b-cluster-teaser.b-vertical-teaser:not(.x-newsstream):nth-child(even):not(.m-even):not(.m-odd) .box {
